            ...
            <div className=" h-1/2">
                <div className=" flex">
                    <div className=" flex md:flex-row flex-col text-base text-[#a0aec0] md:gap-14 gap-2 mb-10 md:mt-10 mt-8 md:w-auto w-full">
                        <a href='https://www.instagram.com/bellinisousse/' className=" hover:text-white duration-200 font-semibold flex justify-start"><FontAwesomeIcon icon={faInstagram} /><span className='px-4'>Instagram</span></a>
